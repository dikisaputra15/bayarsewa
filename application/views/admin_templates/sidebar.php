       ...
       <li class="nav-item <?php if ($this->uri->segment(2) == 'transaksi') echo 'active'; ?>">
          ...
          <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?php if ($this->uri->segment(1) == 'transaction') echo 'alert alert-danger'; ?>" href="https://docs.midtrans.com/en/technical-reference/sandbox-test?id=bank-transfer" target="__blank">Emulator Pembayaran</a>
             </div>
          </div>
       </li>
